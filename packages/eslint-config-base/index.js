...
module.exports = {
	...
	overrides: [
		{
			// not intended for typescript files
			files: ['**/*.tsx', '**/*.ts'],
			rules: {},
		},
	],
	rules: {
		...
		//   mentioned by the styleguide are listed but commented out (so
		//   they don't override a base ruleset).
		// - Rules that are recommended but contradict the styleguide
		//   are explicitly set to the styleguide value.
